...
def test_build_zip_creates_hacs_release_artifact(tmp_path) -> None:
    artifact_path = build_release.build_zip("1.0.0", tmp_path)
    ...
    assert "custom_components/willow/manifest.json" in names
    assert "custom_components/willow/sensor.py" in names
